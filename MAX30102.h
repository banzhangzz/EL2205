...
#define max30102_WR_address 0xAE //8bit
...
#define I2C_BUFFER_LENGTH         128 // HN : defined in Wire.h, 128 for ESP8266
...
class MAX30105 {
 public: 
  ...
  uint8_t Read_Len(uint8_t reg, uint8_t len, uint8_t *buf);
